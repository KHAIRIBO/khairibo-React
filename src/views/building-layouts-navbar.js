...
const BuildingLayoutsNavbar = () => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>7 - Building Layouts - Navbar - bo studio</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="7 - Building Layouts - Navbar - bo studio"
        />
        <meta
      ...
      <div className={styles['container1']}>
        ...
        <Link
          to="/building-layouts-card-alignment"
          className={styles['navlink']}
        >
          <div
            className={` ${styles['container8']} ${projectStyles['thqLink']} `}
          >
            <Tip></Tip>
          </div>
        </Link>
